...
Composes 7: The composition MUST inherit a constituent's invariants PER Execution Contract Conformance 8.
...
Primitive policy 6: [Fanout] MUST NOT normalize an event scope.

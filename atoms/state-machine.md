...
- **HIPAA §164.530(j)** — documentation requirements for covered entities: policies and procedures must be documented. Workflow workflows governing patient-care or administrative processes under HIPAA may use this atom's transition history as the documentation of process execution.

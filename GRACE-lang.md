# GRACE lang v0.51 — Minimal Earned Grammar
...
Term code span: text between backticks outside a fence; it quotes literal text — a code spelling, an expression, a file name, a wire token on a `Projects:` line, a form quoted as a form — and never marks a name, which a reader knows by its declaration rather than by its type.

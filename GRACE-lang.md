...
Term reserved grammar verbs: `EXCEED` (in `MUST NOT EXCEED`) and `IS AUTHORITATIVE FOR` carry grammar semantics; a specification never declares them as record verbs. Every other verb in a rule is a record verb the specification declares.
